    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          <div key={stat.label} className="bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-4 flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-gray-400 mt-1 leading-tight">{stat.sub}</p>
            </div>
          </div>
        ))}
      </div>
