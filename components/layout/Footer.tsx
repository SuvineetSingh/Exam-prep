        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/dashboard" className="text-gray-600 hover:text-primary-600 text-sm transition-colors">
                  Dashboard
                </Link>
              </li>
              <li>
                <Link href="/questions" className="text-gray-600 hover:text-primary-600 text-sm transition-colors">
                  Questions
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/documentation" className="text-gray-600 hover:text-primary-600 text-sm transition-colors">
                  Documentation
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-gray-500 text-sm">
              © {currentYear} Exam Prep Platform. All rights reserved.
            </p>
