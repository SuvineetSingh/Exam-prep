...
// so we don't maintain a 250-entry name table; flags are derived from the code
...
export const COUNTRY_OPTIONS: { code: CountryCode; name: string }[] = COUNTRY_CODES.map((code) => ({
  code,
