...
export default function ExamSetup() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 relative">
      ...
      {/* Back Button - Positioned in the absolute top-left of the page */}
      <div className="absolute top-8 left-8">
        <Link 
          href="/questions" // Adjust this to the actual route of your Questions Browser page
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 shadow-gray-200/50">
          ...
          <div className="space-y-8">
            {/* Exam Type Selection */}
            <div>
              <label className="block text-xs font-bold uppercase text-gray-400 mb-2 font-black">Exam Type</label>
              {fetchingFilters ? (
              ...
              {error && <p className="text-red-500 text-xs mt-2 font-bold ml-1 animate-bounce">{error}</p>}
            </div>

            {/* Question Count Slider */}
            <div>
              <div className="flex justify-between items-end mb-4">
                <label className="block text-xs font-bold uppercase text-gray-400 font-black">Number of Questions</label>
