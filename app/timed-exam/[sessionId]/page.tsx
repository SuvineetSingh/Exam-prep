    ...
    <div className="min-h-screen bg-gray-50 flex overflow-hidden relative">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button 
                onClick={() => { setShowSummaryModal(false); setShowConfirmModal(true); }}
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl border-2 border-blue-100">
            ...
            <p className="text-gray-500 text-center mb-8 font-medium">Do you really want to submit your exam now? This action cannot be undone.</p>
            <div className="flex gap-3">
              <button 
              ...
              <button 
                ...
                className="flex-1 py-3 bg-gray-900 text-white rounded-xl font-bold hover:bg-black transition-colors disabled:opacity-50"
              >
      ...
      {!isSidebarOpen && (
        <button 
          ...
          className="fixed top-6 left-6 z-50 p-3 bg-white shadow-xl border border-gray-100 rounded-xl text-gray-600 hover:text-blue-600 transition-all"
        >
        ...
        <div className="max-w-3xl mx-auto p-4 md:p-8">
          ...
          <div className="flex justify-between items-center px-2">
            <button
              ...
              className="px-8 py-3 bg-slate-200 text-slate-700 rounded-xl font-bold shadow-md hover:bg-slate-300 transition-all transform active:scale-95 disabled:opacity-0 text-sm"
            >
              Previous
            </button>
            ...
            {currentIndex === questions.length - 1 ? (
              <button
                ...
                className="px-10 py-3 bg-gray-900 text-white rounded-xl font-bold shadow-md hover:bg-black transition-all transform active:scale-95 text-sm"
              >
              ...
              <button
                onClick={() => setCurrentIndex(prev => prev + 1)}
                className="px-10 py-3 bg-blue-600 text-white rounded-xl font-bold shadow-md hover:bg-blue-700 transition-all transform active:scale-95 text-sm"
              >
                Next Question
              </button>
            )}
