...
export default function SingleQuestionPractice() {
  ...
  useEffect(() => {
    async function fetchQuestionAndBoundaries() {
      setLoading(true);
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center font-bold text-slate-400">Loading Question...</div>;
