...
export default function LoginPage() {
  ...
  // Grouping state or using more "real-world" naming conventions
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      // Manual override for common Supabase auth errors to make them friendlier
      setStatus({ 
        type: 'error', 
      ...
      // UX choice: let them see the success state for a beat
      setTimeout(() => {
